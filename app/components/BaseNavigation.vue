...
import { useMobileMenu } from '../composables/useMobileMenu' // import shared menu state
  ...
  <header class="py-4 header-shadow sticky top-0 bg-white">
    <nav class="flex container mx-auto items-center justify-between px-3 lg:px-0">
      ...
      >
        ...
        ></span>
        <span
          class="block w-6 h-0.5 bg-gray-800 mt-1 transition-all duration-300"
    ...
    <transition name="fade">
      ...
      >
        ...
        <div class="flex flex-col items-center gap-5 text-xl font-medium text-gray-700">
          ...
          <NuxtLink to="/category/electronics" class="hover:text-blue-600" @click="closeMenu"
            >Electronics</NuxtLink
          >
          <NuxtLink to="/category/jewelery" class="hover:text-blue-600" @click="closeMenu"
            >Jewelery</NuxtLink
          >
          <NuxtLink to="/category/men's clothing" class="hover:text-blue-600" @click="closeMenu"
            >Men</NuxtLink
          >
          <NuxtLink to="/category/women's clothing" class="hover:text-blue-600" @click="closeMenu"
            >Women</NuxtLink
          >
        </div>
      </div>
